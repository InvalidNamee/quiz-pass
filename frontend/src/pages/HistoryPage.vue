...
<template>
  <section>
    ...
    <div class="mt-4 grid gap-3">
      <RouterLink v-for="item in sessions" :key="item.id" class="flex items-center justify-between gap-4 rounded-lg border border-slate-200 bg-white p-4 shadow-sm" :to="`/practice/result/${item.id}`">
